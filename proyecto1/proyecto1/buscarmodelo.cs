...
namespace proyecto1
{
    public partial class buscarmodelo : Form
    {
        ...
        private void buscarmodelo_Load(object sender, EventArgs e)
        {
            this.leer_datos("select productos.modelo,productos.nombre,grupo,productos.marca,productos.existencia,productos.precio from productos", ref resultados, "productos");
        ...
        private void textBox1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            foreach (string palabra in palabras_busqueda)
            {
                ...
                {
                    salida_datos = "(modelo LIKE '%" + palabra + "%')";
                }
                else
                {
                    salida_datos += "AND (modelo LIKE '%" + palabra + "%')";
                }
            }
